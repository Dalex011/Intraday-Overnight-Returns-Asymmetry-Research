...
This is my first ever GitHub repository, so I apologize in advance for any mistake I can make while I learn to navigate the platform!

## **Motivation**

The main goal behind this investigation is to experiment with overnight-intraday returns behaviour. I intend to learn about the different risk-to-reward characteristics of these timeperiods, explore what may cause them, and eventually test whether this well documented anomaly holds true in the Chilean market and in what form.
...
Even though this is my fist time doing such research, I will still attempt to find interesting results and learn from my mistakes along the way.
...
## **Limitations**
- Ten years of data is a small sample for skewness and kurtosis analysis, specially with key events like the Covid-19 pandemic (2020) taking place withing the analyzed period, which likely has outsized influence and hasn't been taken into account yet.
- Sector ETF's are not a liquidity sort, They're a convinient, data-rich way to plot the mechanics of the calculation. The actual liquidity-based cross-sectional tests happens in the Chile phase.

## **Next steps**
Extending this framework to the Chilean equity market (IPSA constituents), which as far as I've reasearched hasn't been tested through this specific overnight/intraday lens. That phase will use a cross-sectional panel regression (liquidity, size, and sector controls) rather than a single-index comparison, directly motivated by the significance caveat above.

## **License**
MIT

### AI Disclosure
This project was developed with the assistance of AI to accelerate code debugging, data visualization structuring, and documentation structure. All financial logic, core methodologies, and final validations are entirely my own.
